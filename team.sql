...
CREATE TABLE `db_active_stu` (
  ...
  `active_id` varchar(64) default NULL COMMENT '活动编号',
  `stu_id` varchar(64) default NULL COMMENT '学生编号',
  `stu_name` varchar(64) default NULL COMMENT '学生姓名',
  `phone` varchar(64) default NULL COMMENT '联系电话',
  `type` varchar(64) default NULL COMMENT '报名状态',
  `is_arrive` varchar(10) default NULL COMMENT '是否正常出息',
  PRIMARY KEY  (`id`)
...
CREATE TABLE `db_message` (
  ...
  `create_stu` varchar(64) default NULL COMMENT '留言学生',
  `audit_type` varchar(10) default NULL COMMENT '审核状态',
  `replay` text COMMENT '回复内容',
  `replay_time` timestamp NULL default '0000-00-00 00:00:00' COMMENT '回复时间',
  `replay_user` varchar(64) default NULL COMMENT '回复人',
  PRIMARY KEY  (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
-- ----------------------------
INSERT INTO `db_message` VALUES ('32ee579f4d97467b991e801c04200545', '活动太少，希望学校各社团多举办一些有意义的活动', '2019-03-27 12:33:20', '3ab03a89859c46498125e35eaf09cd8d', '0', 'qqqq', '2019-03-28 12:33:48', '社团管理人sys');
INSERT INTO `db_message` VALUES ('7dc3208ee4c9400c9a1ac6cf61fba541', 'qqqq', '2019-04-03 10:45:59', '8a32a58f085644268389ebf113e866d6', '0', null, null, null);
INSERT INTO `db_message` VALUES ('94a3149079374c06aafb9d5ae22f095a', '111', '2019-04-03 10:33:52', '8a32a58f085644268389ebf113e866d6', '0', null, null, null);
...
CREATE TABLE `db_site_news` (
  `id` varchar(64) NOT NULL COMMENT '编号',
  `news_type` varchar(64) default NULL COMMENT '新闻状态',
  `title` varchar(64) NOT NULL COMMENT '标题',
  `pic` varchar(200) default NULL COMMENT '新闻主图',
  `short_content` text COMMENT '简介',
  `content` longtext COMMENT '新闻内容',
  `create_user` varchar(64) default NULL COMMENT '创建人',
  `create_time` timestamp NOT NULL default CURRENT_TIMESTAMP on update CURRENT_TIMESTAMP COMMENT '创建时间',
  `is_run` varchar(10) default NULL COMMENT '是否推荐',
  `belon_team` varchar(64) default NULL COMMENT '所属社团',
  `is_audit` varchar(64) default NULL COMMENT '是否审核',
  `ac_start_time` timestamp NULL default NULL,
  `ac_end_time` timestamp NULL default NULL,
  `is_can_apply` varchar(40) default NULL,
  PRIMARY KEY  (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `db_stu_tem` (
  `stu_id` varchar(64) default NULL COMMENT '学生编号',
  `team_id` varchar(64) default NULL COMMENT '社团编号'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `db_student` (
  ...
  `school_room` varchar(200) default NULL COMMENT '学院',
  `class_room` varchar(100) default NULL COMMENT '班级',
...
CREATE TABLE `db_team_applay` (
  `id` varchar(64) NOT NULL COMMENT '编号',
  `applay_team` varchar(64) default NULL COMMENT '申请社团编号',
  `applay_stu` varchar(64) default NULL COMMENT '申请学生',
  `applay_content` text COMMENT '申请理由',
  `applay_time` timestamp NOT NULL default CURRENT_TIMESTAMP on update CURRENT_TIMESTAMP COMMENT '申请时间',
  `applay_type` varchar(64) default NULL COMMENT '申请状态',
  PRIMARY KEY  (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `db_team_applay` VALUES ('baeebec94ea34352b03626652e640fd4', 'c500a06df04742728ab82d7d1728cf43', 'e16473678e3e4f6e9e2a5ff28f616b51', '申请加入社团！', '2019-03-27 19:34:40', '0');
...
CREATE TABLE `db_teams` (
  `id` varchar(64) NOT NULL COMMENT '社团',
  `team_name` varchar(100) default NULL COMMENT '社团名字',
  `pic` varchar(200) default NULL COMMENT '社团宣传图',
  `team_intro` text COMMENT '社团介绍',
  `build_time` timestamp NOT NULL default CURRENT_TIMESTAMP on update CURRENT_TIMESTAMP COMMENT '成立时间',
  `build_stu` varchar(64) default NULL COMMENT '创建人（社长）',
  `audit_type` varchar(64) default NULL COMMENT '审核状态',
...
CREATE TABLE `money_manger` (
  ...
  `act_id` varchar(40) default NULL COMMENT '活动编号',
  `type` varchar(10) default NULL COMMENT '交易类型（1.支出 2.收入）',
...
-- ----------------------------
INSERT INTO `money_manger` VALUES ('95140703-2885-4a09-a51a-70c86884e79e', '6580206a0953478fa99e176ec49767d7', '2', '500', '移动公司赞助500');
INSERT INTO `money_manger` VALUES ('a309ef06-29a1-40c2-be36-a47569588030', '3ab77a7194dc4fa2982a39547c8cc987', '1', '50', '买颁发获奖者的小礼物总消费50');
...
CREATE TABLE `sys_menu` (
  `id` varchar(64) NOT NULL COMMENT '编号',
  `name` varchar(200) default NULL COMMENT '单菜名称',
  `href` varchar(500) default NULL COMMENT '访问地址',
  `target` varchar(64) default NULL COMMENT '目标',
  `is_show` varchar(10) default NULL COMMENT '是否显示',
  `sort` int(11) default NULL COMMENT '排序',
  `parent_id` varchar(64) default NULL COMMENT '父级ID',
  `parent_ids` varchar(1000) default NULL COMMENT '级父ids',
...
-- ----------------------------
-- Trigger structure for insert_menu_role
-- ----------------------------
DELIMITER ;;
